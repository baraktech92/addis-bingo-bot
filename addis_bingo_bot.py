...
# --- CRITICAL CHANGE 1: Updated Minimum Deposit ---
MIN_DEPOSIT = 50.00 
# --- CRITICAL CHANGE 2: Updated Minimum Withdrawal ---
MIN_WITHDRAW = 100.00 
...
# This dictionary tracks the previous state before the bot restarted. 
# It helps prevent balance loss when the in-memory database is reset on re-deployment.
# In a real-world app, this would be handled by an external database (e.g., Firestore).
# We use a key that is unlikely to be generated by a user ID.
PREVIOUS_STATE_KEY = "!!!PREVIOUS_STATE_SNAPSHOT!!!" 
MIGRATION_VERSION = 2.0 # Current version marker
...
# --- 5. Handler Functions (Start, Play, Cancel, Stats) (UPDATED LIMITS) ---
...
# --- WITHDRAW HANDLERS (UPDATED LIMITS) ---
...
# --- DEPOSIT HANDLERS (UPDATED LIMITS) ---
...
# --- 6. Main Function (UPDATED TO CALL MIGRATION) ---
